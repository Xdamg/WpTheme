...
<section class="error-404 not-found">
    <div class="page-content">
        ...
        <h3 class="intro"><?php esc_html_e( 'Page not found!', 'Est-Theme' ); ?></h3>
        <p class="message"><?php echo wp_kses( sprintf( __( "Sorry, we can't find the page you are looking for. Please go to  <a href='%s'>Home.</a>", 'Est-Theme' ), esc_url( home_url( '/' ) ) ), array(
                'a' => array(
                    'href'  => array(),
                    'title' => array()
                )
